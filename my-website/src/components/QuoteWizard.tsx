  ...
  return (
    <div>
      ...
      <div className={styles["quote-wizard-card"]}>
        ...
        <div className={styles["wizard-tabs"]} role="tablist" aria-label="Quote Parameter Selection">
          <button
            type="button"
            id="tab-harness"
            role="tab"
            aria-selected={activeTab === "harness"}
            aria-controls="panel-harness"
        ...
        {/* Tab 1: Harness Form */}
        {activeTab === "harness" && (
          <form onSubmit={handleHarnessSubmit} role="tabpanel" id="panel-harness" aria-labelledby="tab-harness">
